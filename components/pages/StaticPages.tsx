...
const TextPageLayout: React.FC<{ title: string; onBack: () => void; children: React.ReactNode }> = ({ title, onBack, children }) => {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8 lg:p-12 min-h-[600px]">
        <div className="max-w-4xl mx-auto prose prose-slate text-slate-700 leading-relaxed">
          {children}
        </div>
      </div>
    </div>
...
export const AboutPage: React.FC<PageProps> = ({ onBack }) => (
  <TextPageLayout title="Sobre Nós" onBack={onBack}>
    <h3 className="text-xl font-bold text-investor-800 mb-4">Bem-vindo ao CALC INVESTIDOR</h3>
    <p className="mb-6">
    ...
    <h3 className="text-xl font-bold text-investor-800 mb-4">Nossa Missão</h3>
    <p>
...
export const PrivacyPage: React.FC<PageProps> = ({ onBack }) => (
  <TextPageLayout title="Política de Privacidade" onBack={onBack}>
    <p className="text-sm text-slate-500 mb-8">Última atualização: {new Date().getFullYear()}</p>

    <h3 className="text-lg font-bold text-slate-900 mb-3">1. Coleta de Dados</h3>
    <p className="mb-6">
    ...
    <h3 className="text-lg font-bold text-slate-900 mb-3">2. Cookies e Tecnologias de Rastreamento</h3>
    <p className="mb-6">
    ...
    <h3 className="text-lg font-bold text-slate-900 mb-3">3. Links Externos</h3>
    <p className="mb-6">
    ...
    <h3 className="text-lg font-bold text-slate-900 mb-3">4. Contato</h3>
    <p>
...
export const TermsPage: React.FC<PageProps> = ({ onBack }) => (
  <TextPageLayout title="Termos de Uso" onBack={onBack}>
    ...
    <h3 className="text-lg font-bold text-slate-900 mb-3">1. Aceitação dos Termos</h3>
    <p className="mb-6">
    ...
    <h3 className="text-lg font-bold text-slate-900 mb-3">2. Uso Educacional</h3>
    <p className="mb-6">
    ...
    <h3 className="text-lg font-bold text-slate-900 mb-3">3. Isenção de Responsabilidade</h3>
    <p className="mb-6">
    ...
    <h3 className="text-lg font-bold text-slate-900 mb-3">4. Propriedade Intelectual</h3>
    <p className="mb-6">
    ...
    <h3 className="text-lg font-bold text-slate-900 mb-3">5. Alterações</h3>
    <p>
